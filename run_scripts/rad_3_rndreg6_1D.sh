...
python experiments/train.py --device=cuda:0 --edge_mode=RandomRegular --n_random_edges_per_node=6 --neighbors=3 --experiment=E1 --batch_size=16 --lr=1e-4 --unrolling=2 --num_epochs=25 --log=True
