...
python experiments/train2D.py --device=cuda:0 --neighbors=2 --fourier_features=True --edge_mode=RandomRegular --n_random_edges_per_node=10 --batch_size=4 --lr=1e-4 --unrolling=2 --num_epochs=25 --log=True
